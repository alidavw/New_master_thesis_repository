...
DATA_DIR = Path(r"your_file_path")  # working directory ("." by default)
...
train_transform = A.Compose([
    ...
    A.Normalize(mean=(0.568, 0.486, 0.501), std=(0.135, 0.122, 0.125)),
...
val_transform = A.Compose([
    A.Resize(256, 256),
    A.Normalize(mean=(0.559, 0.477, 0.491), std=(0.135, 0.121, 0.124)),
    ToTensorV2(),
])
...
for epoch in range(NUM_EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        trigger_times = 0
        torch.save(model.state_dict(), "Model_Biofilm.pth")
